...
ances": [{"cluster": {"url": "http://jph-vu-chi.demo.redislabs.com:8080", "credentials": {"username": "admin@redisl
abs.org", "password": "admin"}, "name": "jph-vu-chi.demo.redislabs.com"}, "compression": 6}, {"cluster": {"url": "h
ttp://jph-vu-kc.demo.redislabs.com:8080", "credentials": {"username": "admin@redislabs.org", "password": "admin"}, 
"name": "jph-vu-kc.demo.redislabs.com"}, "compression": 6}, {"cluster": {"url": "http://jph-vu-olathe.demo.redislab
s.com:8080", "credentials": {"username": "admin@redislabs.org", "password": "admin"}, "name": "jph-vu-olathe.demo.r
edislabs.com"}, "compression": 6} ], "encryption": true, "ssl":true, "tls_mode":"enabled", "name": "jph-encrypt"}' 
http://localhost:8080/v1/crdbs
