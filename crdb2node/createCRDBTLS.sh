...
curl -v -k -u REDemo@redislabs.com:redis123  -H "Content-Type: application/json" -X POST -d '{"default_db_config": {"name": "crdb-encrypt", "bigstore": false, "authentication_redis_pass":"secretdb01", "replication": false, "memory_size": 102400000, "snapshot_policy": [], "shards_count": 1, "port": 12000}, "instances": [{"cluster": {"url": "http://cluster1.local:8080", "credentials": {"username": "REDemo@redislabs.com", "password": "redis123"}, "name": "cluster1.local"}, "compression": 6}, {"cluster": {"url": "http://cluster2.local:8080", "credentials": {"username": "REDemo@redislabs.com", "password": "redis123"}, "name": "cluster2.local"}, "compression": 6}], "encryption": true, "name": "crdb-encrypt"}' http://localhost:8080/v1/crdbs
EOF
