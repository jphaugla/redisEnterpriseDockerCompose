...
docker-compose -f docker-compose.yml -f docker-compose-bind.yml -f docker-compose-jupyter.yml down
echo "removing the volumes"
./remove_north_volumes.sh
# docker volume rm dnscluster_binddata

echo "starting the containers"
docker-compose -f docker-compose.yml -f docker-compose-jupyter.yml -f docker-compose-bind.yml up -d
